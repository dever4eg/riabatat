// index.js
const { getScanResult, updateItem } = require('./interactionDynamoDB');
const { sendTelegramMessage } = require('./sendingMessagesToTelegram');
const { getCarDetails } = require('./riaAPI.js');
